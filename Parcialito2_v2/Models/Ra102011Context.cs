...
namespace Parcialito2_v2.Models;
...
public partial class Ra102011Context : DbContext
{
    ...
    public virtual DbSet<VistaResultadosEleccione> VistaResultadosElecciones { get; set; }

    protected override void OnConfiguring(DbContextOptionsBuilder optionsBuilder)
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see http://go.microsoft.com/fwlink/?LinkId=723263.
        => optionsBuilder.UseSqlServer("Server=DESKTOP-SPTAS2R; DataBase=RA_102011; Trusted_Connection=True; TrustServerCertificate=True;");
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<VistaResultadosEleccione>(entity =>
        {
            entity
                .HasNoKey()
                .ToView("Vista_ResultadosElecciones");
